...
public class UserController extends Controller{
	...
	*/
	public void getIntegralByOpenId(){
		String openid = this.getPara("openid");
		try {
			Long integral = userService.getIntegralByOpenId(openid);
			this.setAttr("data", integral);
			this.setAttr("success", true);
		} catch (Exception e) {
			this.setAttr("success", false);
		}
	...
	*/
	public void decodeUserInfo(){
		...
		String code = this.getPara("code");
		try {
			JSONObject decodeUserInfo = userService.decodeUserInfo(encryptedData, iv, code);
			this.setAttr("data", decodeUserInfo);
			this.setAttr("success", true);
		} catch (Exception e) {
			this.setAttr("success", false);
		}
